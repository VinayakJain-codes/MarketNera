...
export default function ShopkeeperSignUpPage() {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        const { error } = await supabase.auth.signUp({
            ...
            options: {
                ...
                emailRedirectTo: `${getURL()}${ROUTES.SHOPKEEPER_SETUP.substring(1)}`,
            },
        });
        ...
        if (error) {
            ...
            setMessage("Shop owner account created! Check your email for a confirmation link.");
        }
        setLoading(false);
    };
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-4">
            ...
            <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-[#FF9933]/10 blur-3xl animate-float" />
            <div className="absolute -bottom-32 -right-32 h-80 w-80 rounded-full bg-[#138808]/10 blur-3xl animate-float delay-300" />

            <div className="relative z-10 w-full max-w-md animate-scale-in">
                <div className="auth-card rounded-3xl p-10 shadow-2xl ring-1 ring-[#FF9933]/5 bg-white border border-[#FF9933]/20">
                    {/* Logo */}
                    ...
                    <form className="space-y-4 animate-fade-in-up delay-300" onSubmit={handleSignUp}>
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="auth-input block w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm text-slate-900 focus:border-[#FF9933] focus:ring-1 focus:ring-[#FF9933] outline-none transition-all placeholder-slate-400"
                        ...
                        <Button type="submit" variant="primary" size="lg" className="w-full bg-[#138808] hover:bg-[#138808]/90 text-white" disabled={loading}>
                    ...
                    <p className="mt-6 text-center text-xs text-slate-400 animate-fade-in delay-500">
                        ...
                        <a href={ROUTES.LOGIN_SHOPKEEPER} className="font-semibold text-[#FF9933] hover:text-[#138808] transition-colors">
                            Sign in
                        </a>
                    </p>
                </div>

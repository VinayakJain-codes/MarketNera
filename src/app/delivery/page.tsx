  ...
  return (
    <div className="min-h-screen bg-background-light">
      ...
      <main className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
        <h1 className="text-4xl font-black text-slate-900">Delivery Network</h1>
        <p className="text-slate-500 mt-4 max-w-md">
          Learn about our local delivery network connecting 
          shopkeepers directly to their neighborhood customers.
        </p>

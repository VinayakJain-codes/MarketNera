...
<div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden z-50">
<div className="p-2">
<div className="px-4 py-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Suggested Items</div>
<div className="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 cursor-pointer transition-colors group/item">
<span className="material-symbols-outlined text-primary">eco</span>
<span className="text-sm font-medium">Organic <span className="font-bold">Tomatoes</span></span>
<span className="ml-auto text-xs text-slate-400">In Vegetables</span>
</div>
<div className="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 cursor-pointer transition-colors group/item">
<span className="material-symbols-outlined text-primary">bakery_dining</span>
<span className="text-sm font-medium">Whole Wheat <span className="font-bold">Bread</span></span>
<span className="ml-auto text-xs text-slate-400">In Bakery</span>
</div>
<div className="flex items-center gap-3 px-4 py-3 bg-slate-50 dark:bg-slate-700 cursor-pointer transition-colors group/item">
<span className="material-symbols-outlined text-primary">water_drop</span>
<span className="text-sm font-medium"><span className="font-bold">Fresh</span> Milk</span>
<span className="ml-auto text-xs text-slate-400">In Dairy</span>
</div>
</div>
</div>
</div>
...
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 text-primary focus:ring-primary h-5 w-5" type="checkbox"/>
<span className="text-sm font-medium text-slate-600 dark:text-slate-400 group-hover:text-primary transition-colors">Meat &amp; Seafood</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 text-primary focus:ring-primary h-5 w-5" type="checkbox"/>
<span className="text-sm font-medium text-slate-600 dark:text-slate-400 group-hover:text-primary transition-colors">Beverages</span>
</label>
</div>
</div>
<div>
...
<div>
<h3 className="text-xs font-black uppercase tracking-widest text-navy dark:text-white mb-6">Local Shops</h3>
<div className="space-y-3">
<label className="flex items-center gap-3 cursor-pointer">
<input className="text-primary focus:ring-primary h-5 w-5" name="shop" type="radio"/>
<span className="text-sm font-medium text-slate-600 dark:text-slate-400">Greenery Market</span>
</label>
<label className="flex items-center gap-3 cursor-pointer">
<input className="text-primary focus:ring-primary h-5 w-5" name="shop" type="radio"/>
...
<label className="flex items-center gap-3 cursor-pointer">
<input defaultChecked className="text-primary focus:ring-primary h-5 w-5" name="shop" type="radio"/>
<span className="text-sm font-bold text-navy dark:text-slate-200">Sunshine Organics</span>
</label>
</div>
</div>
</div>
...
<div>
<h1 className="text-3xl font-black text-navy dark:text-white">Fresh Groceries</h1>
<p className="text-slate-500 text-sm mt-1">Showing 124 results in your area</p>
</div>
<div className="flex items-center gap-2">
<span className="text-sm text-slate-500 font-medium">Sort by:</span>
<select className="border-none bg-white dark:bg-slate-800 rounded-lg text-sm font-bold py-2 px-4 pr-10 focus:ring-2 focus:ring-primary">
...
<button className="absolute top-4 right-4 size-10 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-slate-400 hover:text-primary transition-colors">
...
<span className="text-[10px] font-black uppercase text-primary tracking-widest">• Sunshine Organics</span>
</div>
...
<span className="text-[10px] font-black uppercase text-primary tracking-widest">• Dairy Depot</span>
</div>
<button className="w-full bg-primary text-white h-12 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-orange-600 transition-all shadow-lg shadow-primary/20">
<span className="material-symbols-outlined">shopping_basket</span>
                                Add to Cart
...
<span className="text-[10px] font-black uppercase text-primary tracking-widest">• The Hearth Bake</span>
</div>
<button className="w-full bg-primary text-white h-12 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-orange-600 transition-all shadow-lg shadow-primary/20">
<span className="material-symbols-outlined">shopping_basket</span>
                                Add to Cart
...
<span className="text-[10px] font-black uppercase text-primary tracking-widest">• Greenery Market</span>
</div>
<button className="w-full bg-primary text-white h-12 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-orange-600 transition-all shadow-lg shadow-primary/20">
<span className="material-symbols-outlined">shopping_basket</span>
                                Add to Cart

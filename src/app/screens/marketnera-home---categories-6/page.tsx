...
<input className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-full py-3 pl-12 pr-4 focus:ring-2 focus:ring-primary focus:bg-white dark:focus:bg-slate-700 transition-all text-sm" placeholder="Search in Sunshine Organics..." type="text"/>
</div>
</div>
...
<img alt="Store Banner" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB202VitgXwM5sug7nubqMb527DL-dIHGvv9AC0lH00KRaAXJcXWmd-LCu-Uq7PaqoBDzOjp5uEouJT4TPqrvTHVLUh4NZclqj7bG5n0LsbrarQO-JyR_ZwTlock5IXPZztxzYshZxP7EXx0UxqjTuhXXuiTorwkfE1U_7U8t9geqvNfujBXADy-UXfBijY6mYf87rfcPeiiMYvwefFTG5tb5TGmYLMsp4FqA14nAzxciPJGwcybq4kY6Gnf36s63tNDXJKxps3WpJr"/>
<div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
</div>
<div className="max-w-[1600px] mx-auto w-full px-8 -mt-20 relative z-10">
<div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-xl border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-end gap-8">
<div className="size-40 rounded-[2.5rem] bg-white p-2 shadow-2xl shrink-0 -mt-24 border border-slate-100">
<img alt="Sunshine Organics Logo" className="w-full h-full object-cover rounded-[2rem]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBiqsLOYBU7z7eH1MLEYIL93EK4DKEHEunr9o7FO91myhxtKAUhMERs01vKDfk_l6bKhlEv4wQbGFaHClt5e-vfMzfv0dMg1xBHlnoMxmW9L2t1wEz3Jy0i2mtICygx98YKcBn3NJCaQXhFDFBjXZbvyd3gzOg2DJlPku3eBkmJtj-3CDpVzI-0BwyizIV17AH-Ju2vMY2SsrL0DkDc433SF6pjcR3pqdrqpCBZPRYrYQE1BPs1W3DnRDfvDHL2F9jBPoM9bTsHa-zk"/>
</div>
<div className="flex-1 pb-2">
<div className="flex flex-wrap items-center gap-3 mb-2">
<h1 className="text-4xl font-black text-navy dark:text-white">Sunshine Organics</h1>
<div className="flex items-center gap-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-3 py-1 rounded-full text-xs font-bold border border-blue-100 dark:border-blue-800">
<span className="material-symbols-outlined text-sm">verified</span>
                        Verified Local
                    </div>
<div className="flex items-center gap-1 bg-amber-50 dark:bg-amber-900/30 text-amber-600 px-3 py-1 rounded-full text-xs font-bold border border-amber-100">
...
<div className="flex items-center gap-1.5">
<span className="material-symbols-outlined text-lg text-green-500">schedule</span>
                        Open until 8 PM
                    </div>
<p className="w-full md:w-auto mt-2 md:mt-0 italic">"Bringing you the freshest farm-to-table produce since 1995."</p>
</div>
</div>
<div className="flex items-center gap-3 mb-2">
<button className="bg-navy dark:bg-slate-800 text-white flex items-center gap-2 px-6 py-3 rounded-2xl font-bold hover:bg-slate-800 transition-all border border-navy/10">
<span className="material-symbols-outlined">chat</span>
                    Message Shop
                </button>
<button className="size-12 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-400 hover:text-red-500 hover:border-red-100 hover:bg-red-50 transition-all group">
<span className="material-symbols-outlined group-hover:fill-1">favorite</span>
</button>
</div>
</div>
</div>
<div className="flex flex-1 max-w-[1600px] mx-auto w-full mt-8">
<aside className="w-72 shrink-0 border-r border-slate-200 dark:border-slate-800 p-8 hidden lg:block sticky top-24 h-[calc(100vh-120px)] overflow-y-auto scrollbar-hide">
<div className="space-y-10">
<div>
<h3 className="text-xs font-black uppercase tracking-widest text-navy dark:text-white mb-6">Store Categories</h3>
<div className="space-y-1">
<a className="flex items-center justify-between px-4 py-3 bg-primary/10 text-primary rounded-xl font-bold transition-all" href="#">
<span>All Products</span>
<span className="text-xs">48</span>
</a>
<a className="flex items-center justify-between px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl font-medium transition-all group" href="#">
...
<div>
<h2 className="text-2xl font-black text-navy dark:text-white">Shop All Products</h2>
<p className="text-slate-500 text-sm mt-1">48 items available at Sunshine Organics</p>
</div>
<div className="flex items-center gap-2">
<span className="text-sm text-slate-500 font-medium">Sort by:</span>
<select className="border-none bg-white dark:bg-slate-800 rounded-xl text-sm font-bold py-2 px-4 pr-10 focus:ring-2 focus:ring-primary shadow-sm border border-slate-100">
...
<button className="absolute top-4 right-4 size-10 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-slate-400 hover:text-red-500 transition-colors">

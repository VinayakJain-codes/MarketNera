...
function CustomerSignUpPage() {
    ...
    const handleGoogleSignUp = async ()=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
            provider: "google",
            options: {
                redirectTo: `${window.location.origin}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROUTES"].CUSTOMER_DASHBOARD}`,
                queryParams: {
                    access_type: "offline",
                    prompt: "consent"
                }
...
//# sourceMappingURL=src_a8b9fd77._.js.map